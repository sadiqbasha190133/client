        ...
        <footer>
          <div className="row justify-content-center">
            <div className="col-md-5 text-center">
              ...
              <br />
              <p>
                RGUKT,IIIT-Rkvalley,vempalli,kadapa,pin-516411
                <br />
                <i className="fas fa-phone "></i> +91-830-9030895 |{" "}
                <i className="fas fa-print"></i> +91-761-2632524.
                <br />
                <i className="fas fa-envelope"></i> R190077@rguktrkv.ac.in
              </p>
            </div>
          </div>
        </footer>
